...
object DirectoryScanner {
    ...
    fun scanAndCopy2Output(configs: TimingConfig, directory: DirectoryInput, outputProvider: TransformOutputProvider) {
     ...
     */
    private fun scanDirectory(configs: TimingConfig, file: File, save: InputResult) {
        if (file.isDirectory) {
        ...
        // 处理这个类
        ClassHandler.handleClass(configs, inputStream)
    }
}